        ...
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            if (PRICE.getText().toString().equals("") || QUANTITY.getText().toString().equals("")) {
              ...
              Stocks stocks =
                  new Stocks(
                      NAME.getText().toString().replace(" ", "_"), Price, netvalue, Quantity);
              database
                  .getReference()
                  .child("Users")
                  .child(id)
              ...
              Toast.makeText(
                      editstocks.this,
                      NAME.getText().toString() + "STOCK BOUGHT",
                      Toast.LENGTH_SHORT)
                  .show();
        ...
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            if (sq <= 0.0) {
              ...
              view.startAnimation(shake);
              Toast.makeText(
                      editstocks.this, "NOTHING TO SELL PLEASE BUY SOME FIRST", Toast.LENGTH_SHORT)
                  .show();
              ...
              if (PRICE.getText().toString().equals("")
                ...
                Toast.makeText(editstocks.this, NAME.getText() + " SOLD", Toast.LENGTH_SHORT)
                    .show();
                Intent intent = new Intent(editstocks.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
